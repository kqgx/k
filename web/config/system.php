...
return array(
	...
	'SYS_LOG'                       => 1, //后台操作日志开关
	'SYS_KEY'                       => '167EF05DBB11FE24651C', //网站安全密钥
	'SYS_REFERER'                   => 'MGQZNJAZNJM1ZDDJYJMZNZK2NGQ3NTJLMTM4NTHJOWM0OTM5NJK2ZGI2ZDJJZDRL', //移动端api安全密钥
	'SYS_DEBUG'                     => 1, //调试器开关
	...
	'SYS_ATTACHMENT_DB'             => 1, //附件归档存储开关
	'SYS_UPLOAD_DIR'                => 'uploadfile', //附件上传目录
	'SYS_CATE_SHARE'                => 0, //共享栏目展示方式
	'SYS_ATTACHMENT_URL'            => '/uploadfile/', //附件域名设置
	...
	'SYS_TEMPLATE'                  => 'views', //网站风格目录名称
	'SYS_THUMB_DIR'                 => 'file/thumb', //缩略图目录
	'SYS_NAME'                      => 'IMTCMS', //
	'SYS_CMS'                       => '', //
	'SYS_NEWS'                      => 0, //
