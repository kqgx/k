...
class F_Shipping extends A_Field {
	...
	public function input($cname, $name, $cfg, $value = NULL, $id = 0) {
		...
		$str.= '<option value="0" '.(!$value ? ' selected' : '').'>'.L('包邮').'</option>';
		...
		$str.= '</select></label>&nbsp;&nbsp;<label><a href="'.dr_member_url(APP_DIR.'/shipping/index').'" style="color:blue" target="_blank"> '.L('[新建运费模板]').'</a></label>';
