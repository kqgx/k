...
abstract class OAuth2_Provider
{
    ...
    public function tokenFactory($name, array $options)
    {
        $options['uid_key'] = $this->uid_key;
        $options['nick_key'] = $this->nick_key;
        $options['access_token_key'] = $this->access_token_key;
