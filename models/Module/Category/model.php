...
class Module_Category_model extends CI_Model {
	...
	public function get_permission($id) {
		...
		return string2array($data['permission']);
	}
	...
	public function get($id) {
		...
		if (isset($data['permission'])) {
            $data['permission'] = string2array($data['permission']);
        }
	...
	public function get_data() {
		...
		foreach ($_data as $t) {
            ...
            $t['permission'] = string2array($t['permission']);
			$data[$t['id']]	= $t;
		}
	...
	public function edit($id, $data, $_data, $field = array()) {
		...
		$update = array(
            ...
            'letter' => $data['letter'] ? $data['letter'] : $data['dirname']{0},
            'dirname' => str_replace(array('/', '-', '_'), '', $data['dirname']),
            'setting' => array2string(array_merge($_data['setting'], $data['setting'])),
            'permission' => array2string($permission)
        );
     ...
     * 栏目下级或者同级栏目
     */
    public function related($mod, $catid) {
