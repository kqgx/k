...
class Extends_Table_Admin extends M_Controller {
	...
	protected function _edit() {
		...
		if (IS_POST) {
			...
			if (isset($post['error'])) {
				...
				$this->admin_msg(L('操作成功，正在刷新...'), dr_url(APP_DIR.'/'.$this->router->class.'/index', $this->post_param), 1);
			}
		}
